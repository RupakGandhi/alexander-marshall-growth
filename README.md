...
> **Last deploy**: June 5, 2026 (pass 2) — **guided tour no longer auto-launches** for anyone (still available via the "Guided Tour" button) + new `E2E_TEST_PLAN.md` covering every role's artifact, PD, and observation workflow for an external test agent (see CHANGELOG.md)
